...
var _TensorBase_instances, _TensorBase_createCalculatingTensorByNode, _CreatingTensor_resolved, _CreatingTensor_init, _CalculatingTensor_init, _CalculatingTensor_resolved, _CalculatingTensor_createdChildren;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CalculatingTensor = exports.CreatingTensor = exports.ResolvedTensor = void 0;
...
var TensorBase = /** @class */ (function () {
    ...
    TensorBase.prototype.add = function (other) {
        return __classPrivateFieldGet(this, _TensorBase_instances, "m", _TensorBase_createCalculatingTensorByNode).call(this, {
            type: 'add',
            left: this.node,
            right: other.node,
        }, [other]);
...
_TensorBase_instances = new WeakSet(), _TensorBase_createCalculatingTensorByNode = function _TensorBase_createCalculatingTensorByNode(node, others) {
    return new CalculatingTensor({
        adapter: this.adapter,
        node: node,
        createPromises: createCreatePromises(__spreadArray([this], others, true)),
    });
};
...
var CreatingTensor = /** @class */ (function (_super) {
    ...
    function CreatingTensor(init) {
        ...
        if (init.data instanceof Promise) {
            ...
            __classPrivateFieldSet(_this, _CreatingTensor_resolved, new ResolvedTensor({
                data: init.data,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (__classPrivateFieldGet(this, _CreatingTensor_resolved, "f")) {
                            return [2 /*return*/, __classPrivateFieldGet(this, _CreatingTensor_resolved, "f")];
                        }
                        return [4 /*yield*/, __classPrivateFieldGet(this, _CreatingTensor_init, "f").data];
                    case 1:
                        data = _a.sent();
                        __classPrivateFieldSet(this, _CreatingTensor_resolved, new ResolvedTensor({
                            data: data,
                            adapter: __classPrivateFieldGet(this, _CreatingTensor_init, "f").adapter,
                        }), "f");
                        this.node.data = data;
                        return [2 /*return*/, __classPrivateFieldGet(this, _CreatingTensor_resolved, "f")];
                }
    ...
    CreatingTensor.prototype.toArray = function () {
        return this.resolve().then(function (tensor) { return tensor.toArray(); });
    };
...
var CalculatingTensor = /** @class */ (function (_super) {
    ...
    function CalculatingTensor(init) {
        ...
        _CalculatingTensor_createdChildren.set(_this, false
        /**
    ...
    CalculatingTensor.prototype.create = function () {
        ...
        var promises = __classPrivateFieldGet(this, _CalculatingTensor_init, "f").createPromises;
    ...
    CalculatingTensor.prototype.resolve = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (__classPrivateFieldGet(this, _CalculatingTensor_resolved, "f")) {
                            return [2 /*return*/, __classPrivateFieldGet(this, _CalculatingTensor_resolved, "f")];
                        }
                        return [4 /*yield*/, __classPrivateFieldGet(this, _CalculatingTensor_init, "f").adapter.calculate(__classPrivateFieldGet(this, _CalculatingTensor_init, "f").node)];
                    case 1:
                        data = _a.sent();
                        __classPrivateFieldSet(this, _CalculatingTensor_resolved, new ResolvedTensor({
                            data: data,
                            adapter: __classPrivateFieldGet(this, _CalculatingTensor_init, "f").adapter,
                        }), "f");
                        return [2 /*return*/, __classPrivateFieldGet(this, _CalculatingTensor_resolved, "f")];
                }
            });
...
_CalculatingTensor_init = new WeakMap(), _CalculatingTensor_resolved = new WeakMap(), _CalculatingTensor_createdChildren = new WeakMap();
